...
import SpreadPreventItem from "../../components/SpreadPreventItem/SpreadPreventItem";
...
const SpreadPreventPanel = () => {
  return (
    <div style={{ marginTop: '36px' }}>
      <div>
        <div style={{ marginBottom: "40px" }}><Title level={3}>Steps to help prevent the spread of COVID-19 if you
          are sick</Title></div>
        <SpreadPreventItem title="Stay home except to get medical care"
        ...
        <SpreadPreventItem title="Cover your coughs and sneezes"
        ...
        <SpreadPreventItem title="Clean your hands often"
        ...
        <SpreadPreventItem title="Clean all “high-touch” surfaces everyday"
